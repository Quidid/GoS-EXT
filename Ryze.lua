...
print("// Test Script 0.1 | Ryze Loaded - //"..myHero.charName.."")
print("// Version: Private")
print("such wow scripts")
...
function Ryze:LoadMenu()
	...
	self.Menu.Mode.LaneClear:MenuElement({id = "Q", name = "Use [Q]", value = true, leftIcon = "http://news.cdn.leagueoflegends.com/public/images/articles/2015/april_2015/RUP/Q.jpg"})
	self.Menu.Mode.LaneClear:MenuElement({id = "W", name = "Use [W]", value = true, leftIcon = "http://news.cdn.leagueoflegends.com/public/images/articles/2015/april_2015/RUP/W.jpg"})
	self.Menu.Mode.LaneClear:MenuElement({id = "E", name = "Use [E]", value = true, leftIcon = "https://vignette3.wikia.nocookie.net/leagueoflegends/images/8/81/Spell_Flux.png"})
	...
	self.Menu.Mode.JungleClear:MenuElement({id = "Q", name = "Use [Q]", value = true, leftIcon = "http://news.cdn.leagueoflegends.com/public/images/articles/2015/april_2015/RUP/Q.jpg"})
	self.Menu.Mode.JungleClear:MenuElement({id = "W", name = "Use [W]", value = true, leftIcon = "http://news.cdn.leagueoflegends.com/public/images/articles/2015/april_2015/RUP/W.jpg"})
	self.Menu.Mode.JungleClear:MenuElement({id = "E", name = "Use [E]", value = true, leftIcon = "https://vignette3.wikia.nocookie.net/leagueoflegends/images/8/81/Spell_Flux.png"})
	self.Menu.Mode.JungleClear:MenuElement({type = MENU, id = "mm", name = "Mana Manager"})
	self.Menu.Mode.JungleClear.mm:MenuElement({id = "Qmana", name = "Min. mana to [Q]", value = 60, min = 0, max = 100, step = 2})
	self.Menu.Mode.JungleClear.mm:MenuElement({id = "Rmana", name = "Min. mana to [W]", value = 50, min = 0, max = 100, step = 2})
	self.Menu.Mode.JungleClear.mm:MenuElement({id = "Rmana", name = "Min. mana to [E]", value = 50, min = 0, max = 100, step = 2})
	-------Draw---------
...
if (not _G.SDK and not _G.GOS and not _G.EOWLoaded) then return end
	...
	elseif GetPercentHP(myHero) <= self.Menu.Mode.Combo.Health:Value()  then
...
function Ryze:Harass(target)
	if (myHero.mana/myHero.maxMana >= Ryze.Harass.Mana:Value() / 100) then
		if Ready(_W) and self.Menu.Mode.Combo.W:Value() then
